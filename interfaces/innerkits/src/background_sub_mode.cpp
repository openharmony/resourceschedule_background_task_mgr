...
std::string BackgroundSubMode::GetBackgroundSubModeStr(uint32_t mode)
{
    auto iter = PARAM_BACKGROUND_SUBMODE_STR_MAP.find(mode);
    if (iter != PARAM_BACKGROUND_SUBMODE_STR_MAP.end()) {
