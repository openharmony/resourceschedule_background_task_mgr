...
constexpr int32_t SPECIAL_SCENARIO_PROCESSING = 12;
constexpr int32_t END = 13;
...
constexpr uint32_t MODE_AV_PLAYBACK_AND_RECORD = 11;
constexpr uint32_t MODE_SPECIAL_SCENARIO_PROCESSING = 12;
constexpr uint32_t MODE_END = 13;
