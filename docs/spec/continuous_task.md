...
| `MODE_USB_CONNECTION` | 16 | USB连接 | `SUBMODE_NORMAL_NOTIFICATION`（2） | 普通通知 | CANCEL_NOT_USE_USB（16）<br>SUSPEND_USB_NOT_USED（20） |
...
| 接入播控中心或已有实况通知 | USB_CONNECTION | 申请类型不包含VOIP,LOCATION,AUDIO_RECORDING |
