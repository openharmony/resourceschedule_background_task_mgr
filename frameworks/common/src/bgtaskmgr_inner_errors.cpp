...
const std::unordered_map<int32_t, std::string> SA_ERRCODE_MSG_MAP = {
    ...
    {ERR_BGTASK_KEEPING_TASK_VERIFY_ERR,
        ...
        "Current device can not request continuous tasks of the KEEPING_TASK type."},
...
std::string BusinessErrorMap::GetSaErrMsg(int32_t errCode)
{
...
std::string BusinessErrorMap::GetParamErrMsg(int32_t errCode)
{
