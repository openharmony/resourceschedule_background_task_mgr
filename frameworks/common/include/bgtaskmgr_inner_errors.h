...
enum : int32_t {
    ...
    ERR_BGTASK_CONTINUOUS_BANNER_NOTIFICATION_FAIL,
    ERR_BGTASK_CONTINUOUS_API_VERSION_FAIL,
    ERR_BGTASK_CONTINUOUS_TRIGGER_CALLBACK,
    ...
    ERR_BGTASK_CONTINUOUS_MODE_USB_NOT_SUPPORT_DEVICETYPE = 980000801,
