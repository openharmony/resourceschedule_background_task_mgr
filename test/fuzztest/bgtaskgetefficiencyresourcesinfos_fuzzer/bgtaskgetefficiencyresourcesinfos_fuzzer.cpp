...
#include "bgtaskgetefficiencyresourcesinfos_fuzzer.h"
#include "securec.h"
...
namespace BackgroundTaskMgr {
    ...
    bool DoSomethingInterestingWithMyAPI(const char* data, size_t size)
    {
        ...
        uint32_t code = static_cast<uint32_t>(BackgroundTaskMgrStubInterfaceCode::GET_EFFICIENCY_RESOURCES_INFOS);
