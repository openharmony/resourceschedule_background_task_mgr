...
BgTaskHiTraceChain::BgTaskHiTraceChain(const bool isClearId, const char *name)
{
    if (isClearId) {
        HiTraceChainClearId();
        isBegin_ = true;
...
BgTaskHiTraceChain::BgTaskHiTraceChain(const char *name, const int32_t flags)
{
...
BgTaskHiTraceChain::~BgTaskHiTraceChain()
{
    if (isBegin_) {
