...
public:
    ...
    void ParseDisSchedRecordToStr(nlohmann::json &value);
    bool ParseDisSchedRecordFromJson(const nlohmann::json &value, std::set<int32_t> &uidSet);
    void ClearData();
...
private:
    ...
    bool ParseRecordFromJsonByType(const nlohmann::json &value, std::set<int32_t> &uidSet,
