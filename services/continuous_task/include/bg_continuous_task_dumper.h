...
#ifndef FOUNDATION_RESOURCESCHEDULE_BACKGROUND_TASK_MGR_SERVICES_CONTINUOUS_TASK_INCLUDE_BG_CONTINUOUS_TASK_DUMPER_H
...
private:
    DECLARE_DELAYED_SINGLETON(BgContinuousTaskDumper);
};
}  // namespace BackgroundTaskMgr
}  // namespace OHOS
#endif